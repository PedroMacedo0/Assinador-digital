document.addEventListener('DOMContentLoaded', () => {
  ...
  // Preencher datas dinamicamente com base no dia atual se vazias
  ...
  if (dataContratacaoInput && !dataContratacaoInput.value) {
    dataContratacaoInput.value = `${day}/${month}/${year}`;
  }
  ...
  if (vigenciaInput && !vigenciaInput.value) {
    ...
    vigenciaInput.value = `01/${nextMonthStr}/${nextMonthYear}`;
  }
